module Lang.Pietre.Export.PrettyPrinting.AST.Validated.Rendering
  ( Annotation (..)
  , renderInterface
  , renderExpression
  ) where
...
import Lang.Pietre.Export.PrettyPrinting.Common
...
renderInterface :: Interface -> Doc Annotation
renderInterface = prettyInterface >>> runPrinter

renderExpression :: Typed Expression -> Doc Annotation
renderExpression = prettyExpression >>> runPrinter
