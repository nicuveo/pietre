...
prettyValidatedExprName = \case
  Validated.LocalVariableExpr            {} -> "a local variable"
  Validated.ReferenceArgumentExpr        {} -> "a reference argument"
  Validated.IndexExpr                    {} -> "an indexing expression"
  Validated.FunctionNameExpr             {} -> "a function"
  Validated.FunctionCallExpr             {} -> "a function call"
  Validated.VariableCallExpr             {} -> "a function call"
  Validated.ArrayExpr                    {} -> "an array expression"
  Validated.StructExpr                   {} -> "a struct expression"
  Validated.FieldAccessExpr              {} -> "a field access expression"
  Validated.BoolLiteralExpr              {} -> "a literal"
  Validated.IntLiteralExpr               {} -> "a literal"
  Validated.CharLiteralExpr              {} -> "a literal"
  Validated.StringLiteralExpr            {} -> "a literal"
  Validated.IntNegationExpr              {} -> "a boolean expression"
  Validated.BoolNegationExpr             {} -> "a boolean expression"
  Validated.AdditionExpr                 {} -> "an arithmetic expression"
  Validated.SubtractionExpr              {} -> "an arithmetic expression"
  Validated.MultiplicationExpr           {} -> "an arithmetic expression"
  Validated.DivisionExpr                 {} -> "an arithmetic expression"
  Validated.ModuloExpr                   {} -> "an arithmetic expression"
  Validated.ExponentiationExpr           {} -> "an arithmetic expression"
  Validated.EqualityExpr                 {} -> "a comparison expression"
  Validated.DifferenceExpr               {} -> "a comparison expression"
  Validated.GreaterExpr                  {} -> "a comparison expression"
  Validated.LesserExpr                   {} -> "a comparison expression"
  Validated.GreaterEqExpr                {} -> "a comparison expression"
  Validated.LesserEqExpr                 {} -> "a comparison expression"
  Validated.BoolAndExpr                  {} -> "a boolean expression"
  Validated.BoolOrExpr                   {} -> "a boolean expression"
  Validated.CastExpr                     {} -> "a cast expression"
  Validated.RangeExpr                    {} -> "a range expression"
  Validated.AssignmentExpr               {} -> "an assignment expression"
  Validated.AdditionAssignmentExpr       {} -> "an assignment expression"
  Validated.SubtractionAssignmentExpr    {} -> "an assignment expression"
  Validated.MultiplicationAssignmentExpr {} -> "an assignment expression"
  Validated.DivisionAssignmentExpr       {} -> "an assignment expression"
  Validated.ModuloAssignmentExpr         {} -> "an assignment expression"
  Validated.ExponentiationAssignmentExpr {} -> "an assignment expression"

prettyResolvedExprName :: Resolved.Expression -> Doc ()
prettyResolvedExprName = \case
  Resolved.PathExpr                     {} -> "a path expression"
  Resolved.FieldAccessExpr              {} -> "a field access expression"
  Resolved.CallExpr                     {} -> "a function call expression"
  Resolved.ArrayExpr                    {} -> "an array expression"
  Resolved.IndexExpr                    {} -> "an indexing expression"
  Resolved.StructExpr                   {} -> "a struct expression"
  Resolved.BoolLiteralExpr              {} -> "a literal"
  Resolved.IntLiteralExpr               {} -> "a literal"
  Resolved.CharLiteralExpr              {} -> "a literal"
  Resolved.StringLiteralExpr            {} -> "a literal"
  Resolved.ReferenceExpr                {} -> "a reference expression"
  Resolved.IntNegationExpr              {} -> "a boolean expression"
  Resolved.BoolNegationExpr             {} -> "a boolean expression"
  Resolved.AdditionExpr                 {} -> "an arithmetic expression"
  Resolved.SubtractionExpr              {} -> "an arithmetic expression"
  Resolved.MultiplicationExpr           {} -> "an arithmetic expression"
  Resolved.DivisionExpr                 {} -> "an arithmetic expression"
  Resolved.ModuloExpr                   {} -> "an arithmetic expression"
  Resolved.ExponentiationExpr           {} -> "an arithmetic expression"
  Resolved.EqualityExpr                 {} -> "a comparison expression"
  Resolved.DifferenceExpr               {} -> "a comparison expression"
  Resolved.GreaterExpr                  {} -> "a comparison expression"
  Resolved.LesserExpr                   {} -> "a comparison expression"
  Resolved.GreaterEqExpr                {} -> "a comparison expression"
  Resolved.LesserEqExpr                 {} -> "a comparison expression"
  Resolved.BoolAndExpr                  {} -> "a boolean expression"
  Resolved.BoolOrExpr                   {} -> "a boolean expression"
  Resolved.CastExpr                     {} -> "a cast expression"
  Resolved.RangeInclusiveExpr           {} -> "a range expression"
  Resolved.RangeExclusiveExpr           {} -> "a range expression"
  Resolved.AssignmentExpr               {} -> "an assignment expression"
  Resolved.AdditionAssignmentExpr       {} -> "an assignment expression"
  Resolved.SubtractionAssignmentExpr    {} -> "an assignment expression"
  Resolved.MultiplicationAssignmentExpr {} -> "an assignment expression"
  Resolved.DivisionAssignmentExpr       {} -> "an assignment expression"
  Resolved.ModuloAssignmentExpr         {} -> "an assignment expression"
  Resolved.ExponentiationAssignmentExpr {} -> "an assignment expression"
